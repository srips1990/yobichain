...
sleep 3
echo '----------------------------------------'
echo -e ${CYAN}${bold}'SAVING PASSWORDS:'${normal}${LIGHTYELLOW}
echo '----------------------------------------'

echo 'MYSQL_ROOT_PASS='$MYSQL_ROOT_PASS > /root/passwords
echo 'PHPMyAdmin App Password='$AUTOGENERATED_PASS >> /root/passwords
fatattr +hs /root/passwords
cat /root/passwords